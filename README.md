...
## LitCovid
[LitCovid](https://www.ncbi.nlm.nih.gov/research/coronavirus/) is a curated literature hub for tracking up-to-date scientific information about SARS-CoV-2 and COVID-19. It is the most comprehensive resource on the subject, with new articles from PubMed and PubMed Central added daily. PubTator annotations for LitCovid are updated once per day, and can be downloaded from the [NCBI LitCovid FTP site](ftp://ftp.ncbi.nlm.nih.gov/pub/lu/LitCovid/).

## CORD-19
[CORD-19](https://pages.semanticscholar.org/coronavirus-research), the COVID-19 Open Research Dataset is (description) and privided by the [Allen Institute](https://alleninstitute.org/). PubTator annotations for CORD-19 are updated weekly, and can be downloaded from the [NCBI CORD-19 FTP site](ftp://ftp.ncbi.nlm.nih.gov/pub/lu/CORD19/).
